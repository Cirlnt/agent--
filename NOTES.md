...
2. **M2 工程地基**：prompt / 结构化输出 / tool calling 实战（Claude+OpenAI 双写）、流式、成本与 token（第 2 课 工具说明书 ✅、第 3 课 结构化输出 ✅，均已实证完成回填；M2 剩余：prompt 工程（含 system vs description 分工钩子）、流式、成本与 token）
